 ...
 * 时间: 2017/8/16
 */
public class SwRoundImageView extends ImageView {
    ...
    public SwRoundImageView(Context context) {
        this(context, null);
        mContext = context;
    }

    public SwRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwRoundImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (borderWidth > 0) {
            ...
            canvas.drawCircle(width / 2, height / 2, (width - 3 * borderWidth) / 2, paint);
        }
   /*     Paint shadowPaint = new Paint();
        ...
        shadowPaint.setShadowLayer(1, 0, 0, getResources().getColor(R.color.shadow_color));
    ...
    public static Bitmap getCroppedBitmap(Bitmap bmp, int radius) {
        ...
        canvas.drawCircle(sbmp.getWidth() / 2,
                sbmp.getHeight() / 2, sbmp.getWidth() / 2 - 3 * borderWidth, paint);
